...
wget http://wonka.mw.lab.eng.bos.redhat.com/rhd/devstudio/10.0/staging/builds/devstudio-${versionWithRespin_ds}-build-product/latest/all/
installerJar=$(cat index.html | grep -v latest | grep installer-standalone.jar\" | sed "s#.\+href=\"\([^\"]\+\)\">.\+#\1#")
echo "Installer jar: ${installerJar}"
rm -f index.html
time wget http://wonka.mw.lab.eng.bos.redhat.com/rhd/devstudio/10.0/staging/builds/devstudio-${versionWithRespin_ds}-build-product/latest/all/${installerJar}
...
2. Chris signs it, and gives back a URL,eg., http://download-node-02.eng.bos.redhat.com/devel/candidates/jboss/devstudio/JBDS-10.4.0/rpms/signed/
...
signedURL=http://download.devel.redhat.com/devel/candidates/jboss/devstudio/devstudio-10.4.0.GA/rpms/signed
versionWithRespin_ds=10.4.0.GA
ccijenkins=https://dev-platform-jenkins.rhev-ci-vms.eng.rdu2.redhat.com/job
JP=/tmp/jbt.github/jbosstools-build-ci/util/jenkinsPost.sh
...
cat <<EOF > /etc/yum.repos.d/rh-eclipse46-devstudio-10.4.0.repo

[rh-eclipse46-devstudio-staging-10.4.0]
name=rh-eclipse46-devstudio-staging-10.4.0
baseurl=https://devstudio.redhat.com/10.0/staging/builds/devstudio-10.4.0.GA-build-rpm/latest/x86_64/
enabled=1
gpgcheck=1
upgrade_requirements_on_install=1
metadata_expire=2m

[rh-eclipse46-devstudio-snapshots-10.4.0]
name=rh-eclipse46-devstudio-snapshots-10.4.0
baseurl=https://devstudio.redhat.com/10.0/snapshots/rpms/10.4.0/x86_64/
enabled=0
gpgcheck=0
upgrade_requirements_on_install=1
...
# If you already have rh-eclipse46-devstudio installed (can add --best flag for Fedora install)
yum update rh-eclipse46-devstudio -y

# Or, if not already installed
yum install rh-eclipse46-devstudio -y
...
[source,bash]
----
Error: Package rh-eclipse46-devstudio-10.4-0.20170218.1756.el7.x86_64.rpm is not signed
----

Alternatively, you could download the rpms from https://devstudio.redhat.com/10.0/staging/builds/devstudio-10.4.0.GA-build-rpm/latest/x86_64/
