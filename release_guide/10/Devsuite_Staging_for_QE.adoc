...
https://raw.githubusercontent.com/jbdevstudio/jbdevstudio-product/jbosstools-4.4.x/results/customer-portal/devsuite.detailed-description.html
https://raw.githubusercontent.com/jbdevstudio/jbdevstudio-product/jbosstools-4.4.x/results/customer-portal/devsuite.manual-instructions.txt

First connect to dev01.hosts.mwqe.eng.bos.redhat.com as +hudson+ user (requires permissions).
