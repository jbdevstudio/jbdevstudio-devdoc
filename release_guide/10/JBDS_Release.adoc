...
Connect to dev01.hosts.mwqe.eng.bos.redhat.com as +hudson+ user (requires permissions).

[source,bash]
----
me@local$ ssh dev01.hosts.mwqe.eng.bos.redhat.com
...
versionWithRespin_ds=10.4.0.AM1 # a, b, c...
...
To get the SHA256 values for easy pasting into the product.yml file, first connect to dev01.hosts.mwqe.eng.bos.redhat.com as +hudson+ user (requires permissions).

[source,bash]
----
me@local$ ssh dev01.hosts.mwqe.eng.bos.redhat.com # or dev90
me@dev01$ sudo su - hudson
hudson@dev01$ ...
----
...
Commit changes and submit PR, eg., https://github.com/jbosstools/jbosstools-website/pull/692, https://github.com/jbosstools/jbosstools-website/pull/651 or https://github.com/jbosstools/jbosstools-website/pull/664
...
blogURL=/blog/4.4.4.am1-for-neon.2.html
pullrequestNum=692
