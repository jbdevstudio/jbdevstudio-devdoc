...
Notify Jeff that the website is ready to be updated with a new blog post.
...
pullrequestNum=664
eclipseVersion="Eclipse 4.6.2 Neon.2"
...
blogURL=${blogURL}&pullrequestNum=${pullrequestNum}&eclipseVersion=${eclipseVersion}"
  sleep 10s
  ${JP} -j ${j} -t disable
