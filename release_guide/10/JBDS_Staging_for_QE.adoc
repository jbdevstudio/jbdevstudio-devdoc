...
versionWithRespin_ds=10.0.1.AM3 # a, b, c...
...
for site in central earlyaccess; do
  ...
  echo "https://devstudio.redhat.com/10.0/staging/builds/devstudio-${versionWithRespin_ds}-build-${sitename}/ " >> $tmpfile
  echo "https://devstudio.redhat.com/10.0/staging/updates/${sitename}/${versionWithRespin_ds}/ " >> $tmpfile
done
echo "https://devstudio.redhat.com/10.0/staging/builds/devstudio-${versionWithRespin_ds}-build-product/ " >> $tmpfile
echo "http://www.qa.jboss.com/binaries/devstudio/10.0/staging/builds/devstudio-${versionWithRespin_ds}-build-product/ " >> $tmpfile
echo "https://devstudio.redhat.com/10.0/staging/builds/#_____(5_folders_w/_${versionWithRespin_ds}) " >> $tmpfile
echo "https://devstudio.redhat.com/10.0/staging/updates/core/#_____(4_zips,_4_sums,_1_folder_w/_${versionWithRespin_ds}) " >> $tmpfile
echo "https://devstudio.redhat.com/10.0/staging/updates/central/#_____(1_zip,_1_sum,_1_folder_w/_${versionWithRespin_ds}) " >> $tmpfile
echo "https://devstudio.redhat.com/10.0/staging/updates/earlyaccess/#_____(1_zip,_1_sum,_1_folder_w/_${versionWithRespin_ds}) " >> $tmpfile
#echo "https://devstudio.redhat.com/10.0/staging/updates/earlyaccess/devstudio-${versionWithRespin_ds}-updatesite-earlyaccess.zip " >> $tmpfile
#echo "https://devstudio.redhat.com/10.0/staging/updates/earlyaccess/devstudio-${versionWithRespin_ds}-updatesite-earlyaccess.zip.sha256 " >> $tmpfile
echo "" >> $tmpfile
cat $tmpfile
...
versionWithRespin_ds_PREV=10.1.0.AM3 # a, b, c...
versionWithRespin_ds=10.0.1.AM3 # a, b, c...
...
subject="Red Hat JBoss Developer Studio ${versionWithRespin_ds} available for QE testing"
echo "
...
* http://www.qa.jboss.com/binaries/devstudio/10.0/staging/builds/devstudio-${versionWithRespin_ds}-build-product/latest/all/ (EAP bundles; VPN required)
* https://devstudio.redhat.com/10.0/staging/builds/devstudio-${versionWithRespin_ds}-build-product/latest/all/ (Standalone + other zips)

Update Sites:
* https://devstudio.redhat.com/10.0/staging/updates/ (includes ${versionWithRespin_ds} Core + Target Platform + JBoss Central)
* https://devstudio.redhat.com/10.0/staging/updates/discovery.earlyaccess/${versionWithRespin_ds}/ (includes the above site + Early Access)
...
http://www.qa.jboss.com/binaries/devstudio/10.0/staging/builds/devstudio-10.0.1.AM3-build-product/latest/all/
