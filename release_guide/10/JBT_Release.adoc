...
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/job/jbosstools-releng-push-to-dev-stable-02-copy-builds-and-update-sites_master

or, for pushing to /stable/ too (Final/GA builds only), use:

https://jenkins.mw.lab.eng.bos.redhat.com/hudson/job/jbosstools-releng-push-to-dev-stable-02-copy-builds-and-update-sites_4.4.neon
...
for j in jbosstools-releng-push-to-dev-stable-02-copy-builds-and-update-sites_${stream_jbt}; do
...
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/job/jbosstools-releng-push-to-dev-stable-03-verify-builds-update-sites_master/ (check only jbt)
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/job/jbosstools-releng-push-to-dev-stable-03-verify-builds-update-sites_4.4.neon/ (check jbt + devstudio)

[source,bash]
----

google-chrome http://jenkins.mw.lab.eng.bos.redhat.com/hudson/job/jbosstools-releng-push-to-dev-stable-03-verify-builds-update-sites_${stream_jbt}/ &
...
http://wonka.mw.lab.eng.bos.redhat.com/jenkins/view/devstudio/job/jbosstools-releng-push-to-dev-stable-04-update-merge-composites-html_master/
...
for j in jbosstools-releng-push-to-dev-stable-04-update-merge-composites-html_${stream_jbt}; do
...
${wonkajenkins}/${j}/buildWithParameters && echo -n ".B"
  sleep 15s
