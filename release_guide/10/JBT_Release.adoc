...
${STAGE} -sites rpm -stream 10.3.0.AM1 -vr 10.3.0.AM1 -sd 10.0 -dd static/10.0 -st staging -dt stable -JOB_NAME 'devstudio-10.3.0.AM1-build-${site}' -DESTINATION devstudio@10.5.105.197:/www_htdocs/devstudio -DEST_URL https://devstudio.redhat.com -suz -sus
