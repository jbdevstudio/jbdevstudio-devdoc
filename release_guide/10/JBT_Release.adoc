...
versionWithRespin_jbt=4.4.2.AM1
...
# wait until all background tasks (jbt: 8) are done
wait
...
# AM milestones are not released so nothing to verify
#version_ds=10.2.0.AM1
#quals="development"
#if [[ ${version_ds##*GA} == "" ]]; then quals="development stable"; fi # ** ##
#for qual in $quals; do time ${CHECK} -vrds ${version_ds} -dsrv ${devstudioReleaseVersion} -qual $qual; echo ""; done
...
http://download.jboss.org/jbosstools/neon/development/updates/discovery.earlyaccess/4.4.2.AM1/
http://download.jboss.org/jbosstools/static/neon/development/updates/coretests/4.4.2.AM1/

(and, if this is a Final)

http://download.jboss.org/jbosstools/neon/stable/updates/
http://download.jboss.org/jbosstools/neon/stable/updates/discovery.earlyaccess/
http://download.jboss.org/jbosstools/neon/stable/updates/discovery.earlyaccess/4.4.2.AM1/
http://download.jboss.org/jbosstools/static/neon/stable/updates/coretests/4.4.2.AM1/
...
For the first Beta, create a new node on Marketplace, using content from http://download.jboss.org/jbosstools/static/neon/stable/updates/core/4.4.2.AM1/site.properties
...
* Update list of features, using content of http://download.jboss.org/jbosstools/static/neon/stable/updates/core/4.4.2.AM1/site.properties
