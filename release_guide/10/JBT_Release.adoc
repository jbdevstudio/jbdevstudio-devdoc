...
# run stage script, eg., for the rpm
${STAGE} -sites rpm -stream 10.2.0.GA -vr 10.2.0.GA -sd 10.0 -dd static/10.0 -st staging -dt stable -JOB_NAME 'devstudio-10.2.0.GA-build-${site}' -DESTINATION devstudio@10.5.105.197:/www_htdocs/devstudio -DEST_URL https://devstudio.redhat.com -suz -sus
...
versionWithRespin_jbt_PREV=4.4.2.AM3
...
For the first Beta, create a new node on Marketplace, using content from http://download.jboss.org/jbosstools/static/neon/stable/updates/core/4.4.2.Final/site.properties
...
* Update list of features, using content of http://download.jboss.org/jbosstools/static/neon/stable/updates/core/4.4.2.Final/site.properties
...
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_Master/job/jbosstools-releng-push-to-dev-stable-07-notification-emails/configure
