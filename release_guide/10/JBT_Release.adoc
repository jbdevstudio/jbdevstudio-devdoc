...
version=4.4.1.AM2 # release version: no a, b, c suffix
...
http://download.jboss.org/jbosstools/neon/development/updates/discovery.earlyaccess/4.4.1.AM2/
http://download.jboss.org/jbosstools/static/neon/development/updates/coretests/4.4.1.AM2/

(and, if this is a Final)

http://download.jboss.org/jbosstools/neon/stable/updates/
http://download.jboss.org/jbosstools/neon/stable/updates/discovery.earlyaccess/
http://download.jboss.org/jbosstools/neon/stable/updates/discovery.earlyaccess/4.4.1.AM2/
http://download.jboss.org/jbosstools/static/neon/stable/updates/coretests/4.4.1.AM2/
...
TARGET_PLATFORM_VERSION_MAX=4.60.1.AM2-SNAPSHOT
now=`date +%s000`
TOOLS=tools@filemgmt.jboss.org:/downloads_htdocs/tools
...
For the first Beta, create a new node on Marketplace, using content from http://download.jboss.org/jbosstools/static/neon/stable/updates/core/4.4.1.AM2/site.properties
...
* Update list of features, using content of http://download.jboss.org/jbosstools/static/neon/stable/updates/core/4.4.1.AM2/site.properties
