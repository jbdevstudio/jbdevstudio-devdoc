...
versionWithRespin_jbt=4.4.4.AM3
...
version_parent=4.4.4.AM3-SNAPSHOT
versionWithRespin_jbt=4.4.4.AM3
versionWithRespin_ds=10.4.0.AM3
version_jbt=$(echo ${versionWithRespin_jbt} | sed -e '/[abcdwxyz]$/ s/\(^.*\)\(.$\)/\1/') # ***
version_ds=$(echo ${versionWithRespin_ds} | sed -e '/[abcdwxyz]$/ s/\(^.*\)\(.$\)/\1/') # ***
...
versionWithRespin_jbt=4.4.4.AM3
versionWithRespin_ds=10.4.0.AM3
versionWithRespin_ds_PREV=10.4.0.AM2
earlyaccess_IS=
...
versionWithRespin_jbt_PREV=4.4.4.AM2
versionWithRespin_jbt=4.4.4.AM3
versionWithRespin_jbt_NEXT=4.4.4.Final

versionWithRespin_ds_PREV_GA=10.3.0.GA
versionWithRespin_ds_PREV=10.4.0.AM2
versionWithRespin_ds=10.4.0.AM3
versionWithRespin_ds_NEXT=10.4.0.GA
