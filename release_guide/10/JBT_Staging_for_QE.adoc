...
versionWithRespin_jbt=4.4.2.AM1 # a, b, c... (not SNAPSHOT!)
versionWithRespin_ds=10.2.0.AM1
stream_jbt=master # or 4.4.neon
stream_ds=master # or 10.0.neon
...
versionWithRespin_ds=10.2.0.AM1 # a, b, c...
...
* set correct github branch, eg., switch from 4.4.2.AM1x to 4.4.x
