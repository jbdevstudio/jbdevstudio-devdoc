...
versionWithRespin=4.4.0.Alpha2 # a, b, c... (not SNAPSHOT!)
stream_JBT=master # or 4.4.neon
stream_DS=master # or 10.0.neon
...
versionWithRespin_PREV=4.4.0.Alpha1 # a, b, c...
versionWithRespin=4.4.0.Alpha2 # a, b, c...
...
versionWithRespin=4.4.0.Alpha2 # a, b, c...
jbdsFixVersion=10.0.0.Alpha2 # no respin suffix here
jbdsFixVersionWithRespin=10.0.0.Alpha2 # a, b, c...
...
TARGET_PLATFORM_CENTRAL_MAX=4.60.0.Alpha1-SNAPSHOT
jbdsFixVersion=10.0.0.Alpha2 # no respin suffix here
jbtFixVersion=4.4.0.Alpha2 # no respin suffix here
