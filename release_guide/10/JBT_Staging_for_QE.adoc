...
# or
cd ~/tmp & wget https://hudson.eclipse.org/packaging/job/neon.epp-tycho-build/387/artifact/org.eclipse.epp.packages/archive/20160610-1200_eclipse-jee-neon-R-linux.gtk.x86_64.tar.gz &
