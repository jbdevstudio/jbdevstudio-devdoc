...
https://devstudio.redhat.com/10.0/staging/builds/devstudio-${versionWithRespin_ds}-build-discovery.central/latest/all/repo/compositeArtifacts.xml \
https://devstudio.redhat.com/10.0/staging/builds/devstudio-${versionWithRespin_ds}-build-discovery.central/latest/all/repo/devstudio-directory.xml \
https://devstudio.redhat.com/10.0/staging/builds/devstudio-${versionWithRespin_ds}-build-discovery.earlyaccess/latest/all/repo/compositeArtifacts.xml \
https://devstudio.redhat.com/10.0/staging/builds/devstudio-${versionWithRespin_ds}-build-discovery.earlyaccess/latest/all/repo/devstudio-directory.xml
...
URLs="$(egrep -v "#" ide-config.properties | egrep "${version}|${versionWithRespin_jbt}|${dsFixVersion}|${versionWithRespin_ds}" | sed -e "s#.\+|\([0-9.a-zA-Z]\+\)=\(.\+\)#\2#")"
