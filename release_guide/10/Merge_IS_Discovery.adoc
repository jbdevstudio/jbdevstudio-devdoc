...
pushd /tmp
  ...
  ./mergeISdiscovery.sh -version ${jbdsFixVersion} -versionWithRespin ${jbdsFixVersionWithRespin} -is https://devstudio.redhat.com/10.0/staging/updates/integration-stack/discovery/${jbdsFixVersionIS}/earlyaccess/ -JBDS
...
https://devstudio.redhat.com/10.0/staging/updates/discovery.central/${jbdsFixVersionWithRespin}/devstudio-directory.xml \
https://devstudio.redhat.com/10.0/staging/updates/discovery.central/${jbdsFixVersionWithRespin}/plugins/ \
https://devstudio.redhat.com/10.0/staging/updates/discovery.earlyaccess/${jbdsFixVersionWithRespin}/devstudio-directory.xml \
https://devstudio.redhat.com/10.0/staging/updates/discovery.earlyaccess/${jbdsFixVersionWithRespin}/plugins/
...
# JBDS
url=https://devstudio.redhat.com/10.0/staging/updates/discovery.earlyaccess/${jbdsFixVersionWithRespin}/
