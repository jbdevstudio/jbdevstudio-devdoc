...
pushd /tmp
  ...
  ./mergeISdiscovery.sh -version 4.4.0.Alpha1 -versionWithRespin 4.4.0.Alpha1 -is http://download.jboss.org/jbosstools/mars/staging/updates/integration-stack/discovery/4.3.0.Final/earlyaccess/
  ./mergeISdiscovery.sh -version 10.0.0.Alpha1 -versionWithRespin 10.0.0.Alpha1 -is https://devstudio.redhat.com/9.0/staging/updates/integration-stack/discovery/9.0.0.GA/earlyaccess/ -JBDS
...
# JBoss Tools
url=http://download.jboss.org/jbosstools/neon/staging/updates/discovery.central/4.4.0.Alpha1/
...
# JBDS
url=https://devstudio.redhat.com/10.0/staging/updates/discovery.earlyaccess/10.0.0.Alpha1/
...
jboss.discovery.site.integration-stack.url|jbosstools|4.4.0.Alpha1=http://download.jboss.org/jbosstools/neon/staging/updates/integration-stack/discovery/4.4.0.Alpha1/
jboss.discovery.site.integration-stack.url|devstudio|10.0.0.Alpha1=https://devstudio.redhat.com/10.0/staging/updates/integration-stack/discovery/10.0.0.Alpha1/
