...
As of 4.4.0.Alpha1 / 10.0.0.Alpha1, the latest plugins to pull can be found at the URLs below (see script).
...
pushd /tmp
  ...
  ./mergeISdiscovery.sh -version 4.4.0.Alpha2 -versionWithRespin 4.4.0.Alpha2 -is http://download.jboss.org/jbosstools/neon/staging/updates/integration-stack/discovery/4.4.0.Alpha1-SNAPSHOT/earlyaccess/
  ./mergeISdiscovery.sh -version 10.0.0.Alpha2 -versionWithRespin 10.0.0.Alpha2 -is https://devstudio.redhat.com/10.0/staging/updates/integration-stack/discovery/10.0.0.Alpha1-SNAPSHOT/earlyaccess/ -JBDS
...
# JBoss Tools
url=http://download.jboss.org/jbosstools/neon/staging/updates/discovery.central/4.4.0.Alpha2/
...
# JBDS
url=https://devstudio.redhat.com/10.0/staging/updates/discovery.earlyaccess/10.0.0.Alpha2/
...
```
!MESSAGE org.jboss.tools.central.discovery.integration_stack_4.4.0.Alpha1_v20150922_1058_B430.jar_4644660859188953740.jar: Must specify connectorDescriptor/@siteUrl
!STACK 1
...
jboss.discovery.site.integration-stack.url|jbosstools|4.4.0.Alpha2=http://download.jboss.org/jbosstools/neon/staging/updates/integration-stack/discovery/4.4.0.Alpha1-SNAPSHOT/
jboss.discovery.site.integration-stack.url|devstudio|10.0.0.Alpha2=https://devstudio.redhat.com/10.0/staging/updates/integration-stack/discovery/10.0.0.Alpha1-SNAPSHOT/
