...
2. Chris signs it, and gives back a URL,eg., http://download-node-02.eng.bos.redhat.com/devel/candidates/jboss/devstudio/devstudio-11.1.0/rpms/signed/
...
signedURL=http://download-node-02.eng.bos.redhat.com/devel/candidates/jboss/devstudio/devstudio-11.1.0/rpms/signed/
versionWithRespin_ds=11.1.0.GA
ccijenkins=https://dev-platform-jenkins.rhev-ci-vms.eng.rdu2.redhat.com/job
JP=/tmp/jbt.github/jbosstools-build-ci/util/jenkinsPost.sh
...
[rh-eclipse47-devstudio-staging-11.1]
name=rh-eclipse47-devstudio-staging-11.1
...
[source,bash]
----
Error: Package rh-eclipse47-devstudio-11.1-0.20170809.1307.el7.x86_64.rpm is not signed
----
...
signedURL=http://download-node-02.eng.bos.redhat.com/devel/candidates/jboss/devstudio/devstudio-11.1.0/rpms/signed/
signedURL=https://devstudio.redhat.com/11/staging/builds/devstudio-11.1.0.GA-build-rpm/latest/x86_64/
...
for theFile in ${theFiles}; do
  ...
  gpgcheck=$(rpm -K  /tmp/${theFile} | grep "pgp md5 OK")
  if [[ ! ${gpgcheck} ]]; then
