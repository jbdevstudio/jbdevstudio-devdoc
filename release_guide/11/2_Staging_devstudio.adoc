...
2. Chris signs it, and gives back a URL,eg., http://download-node-02.eng.bos.redhat.com/devel/candidates/jboss/devstudio/devstudio-11.2.0/rpms/signed/
...
Alternatively, you could download the rpms from https://devstudio.redhat.com/11/staging/builds/devstudio-11.2.0.GA-build-rpm/latest/x86_64/
...
signedURL=http://download-node-02.eng.bos.redhat.com/devel/candidates/jboss/devstudio/devstudio-11.2.0/rpms/signed/
signedURL=https://devstudio.redhat.com/11/staging/builds/devstudio-11.2.0.GA-build-rpm/latest/x86_64/
