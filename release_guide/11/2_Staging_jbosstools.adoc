...
version_parent=4.5.1.AM3-SNAPSHOT
versionWithRespin_jbt=4.5.1.AM3
versionWithRespin_ds=11.1.0.AM3
...
# else
  stream_jbt=master
# fi
TARGET_PLATFORM_VERSION_MAX=4.71.0.AM3-SNAPSHOT
TARGET_PLATFORM_CENTRAL_MAX=4.71.0.AM3-SNAPSHOT
...
cd ~/tmp; wget http://download.eclipse.org/technology/epp/downloads/release/oxygen/1/eclipse-jee-oxygen-1-linux-gtk-x86_64.tar.gz &
# or
cd ~/tmp; wget https://hudson.eclipse.org/packaging/job/oxygen.epp-tycho-build/348/artifact/org.eclipse.epp.packages/archive/20170907-1650_eclipse-jee-oxygen-1-RC3-linux.gtk.x86_64.tar.gz &
...
for j in jbosstools-releng-push-to-staging-02-copy-builds-and-update-sites_jbt \
         jbosstools-releng-push-to-staging-02-copy-builds-and-update-sites_ds; do
  prevJob=$(${JP} -s ${ccijenkins} -j ${j} -t enable -q); echo "[${prevJob}] ${ccijenkins}/${j} enable"
  sleep 3s
...
versionWithRespin_jbt=4.5.1.AM3
versionWithRespin_ds=11.1.0.AM3
versionWithRespin_ds_PREV=11.1.0.AM2
version_jbt_IS=4.5.0.Final
version_ds_IS=11.0.0.GA
qual_IS=stable
...
versionWithRespin_jbt_PREV_GA=4.5.0.Final
versionWithRespin_jbt_PREV=4.5.1.AM2
versionWithRespin_jbt=4.5.1.AM3
versionWithRespin_jbt_NEXT=4.5.1.AM3

versionWithRespin_ds_PREV_GA=11.0.0.GA
versionWithRespin_ds_PREV=11.1.0.AM2
versionWithRespin_ds=11.1.0.AM3
versionWithRespin_ds_NEXT=11.1.0.AM3
...
# else
  ...
  github_branch=master # later jbosstools-4.5.0.x
# fi
TARGET_PLATFORM_VERSION_MIN=4.70.3.AM3-SNAPSHOT
TARGET_PLATFORM_VERSION_MAX=4.71.0.AM3-SNAPSHOT
TARGET_PLATFORM_CENTRAL_MAX=4.71.0.AM3-SNAPSHOT
respinSuffix=""
ccijenkins=https://dev-platform-jenkins.rhev-ci-vms.eng.rdu2.redhat.com/job
