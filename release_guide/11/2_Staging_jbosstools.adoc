...
version_parent=4.5.1.AM1-SNAPSHOT
versionWithRespin_jbt=4.5.1.AM2
...
# else
  stream_jbt=master
# fi
TARGET_PLATFORM_VERSION_MAX=4.71.0.AM2-SNAPSHOT
...
versionWithRespin_jbt=4.5.1.AM2
versionWithRespin_ds=11.1.0.AM2
versionWithRespin_ds_PREV=11.1.0.AM1
version_jbt_IS=4.5.0.Final
version_ds_IS=11.0.0.GA
qual_IS=stable
...
versionWithRespin_jbt_PREV=4.5.1.AM1
versionWithRespin_jbt=4.5.1.AM2
...
# else
  ...
  github_branch=master # later jbosstools-4.5.0.x
# fi
TARGET_PLATFORM_VERSION_MIN=4.70.3.AM2-SNAPSHOT
TARGET_PLATFORM_VERSION_MAX=4.71.0.AM2-SNAPSHOT
TARGET_PLATFORM_CENTRAL_MAX=4.71.0.AM3-SNAPSHOT
respinSuffix=""
ccijenkins=https://dev-platform-jenkins.rhev-ci-vms.eng.rdu2.redhat.com/job
