...
# devstudio-11.2.0.AM2-target-platform-central.zip
# devstudio-11.2.0.AM2-target-platform-earlyaccess.zip
# devstudio-11.2.0.AM2-target-platform.zip
# devstudio-11.2.0.AM2-updatesite-core.zip
...
blogURL=/blog/4.5.2.AM2-for-oxygen.2.html
# Pull Request (PR)
pullrequestNum=777
eclipseVersionSuffix=".2" # TODO: use .2 for Eclipse 4.7.1 Oxygen.2
GOLIVEDATE="2017-12-12"
