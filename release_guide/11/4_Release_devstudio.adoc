...
# devstudio-11.1.0.GA-target-platform-central.zip
# devstudio-11.1.0.GA-target-platform-earlyaccess.zip
# devstudio-11.1.0.GA-target-platform.zip
# devstudio-11.1.0.GA-updatesite-core.zip
...
blogURL=/blog/11.1.0.ga-for-oxygen.1a.html
# Pull Request (PR)
pullrequestNum=765
