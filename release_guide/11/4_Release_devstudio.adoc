...
# devstudio-11.2.0.AM1-target-platform-central.zip
# devstudio-11.2.0.AM1-target-platform-earlyaccess.zip
# devstudio-11.2.0.AM1-target-platform.zip
# devstudio-11.2.0.AM1-updatesite-core.zip
