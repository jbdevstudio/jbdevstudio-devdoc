...
version_jbt_PREV=4.5.0.Final
version_jbt=4.5.1.AM2
version_jbt_NEXT=4.5.1.AM3

version_ds_PREV_GA=11.0.0.GA
version_ds_PREV=11.0.0.GA
version_ds=11.1.0.AM2
version_ds_NEXT=11.1.0.AM3
...
* Update list of features, using content of http://download.jboss.org/jbosstools/static/oxygen/stable/updates/core/4.5.1.AM2/site.properties
...
sprint_NEXT="devex #138 September 2017"
versionWithRespin_jbt=4.5.1.AM2
...
#else
  version_parent_NEXT=4.5.1.AM3-SNAPSHOT
  createBranch=false
