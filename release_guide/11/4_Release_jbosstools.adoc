...
########
# TODO :: JBIDE-18743 use new job https://dev-platform-jenkins.rhev-ci-vms.eng.rdu2.redhat.com/job/jbosstools-releng-push-to-staging-00-validate-composites here
########
...
versionWithRespin_jbt_PREV=4.5.2.AM1 # previous RELEASED milestone as referenced in ide-config.properties
versionWithRespin_jbt=4.5.2.AM2
...
* Update list of features, using content of http://download.jboss.org/jbosstools/static/oxygen/stable/updates/core/4.5.2.AM2/site.properties
...
sprint_NEXT="devex #142 December 2017"
versionWithRespin_jbt=4.5.2.AM2
versionWithRespin_jbt_NEXT=4.5.2.AM3
versionWithRespin_ds=11.2.0.AM2
versionWithRespin_ds_NEXT=11.2.0.AM3
...
versionWithRespin_jbt_NEXT=4.5.2.Final
versionWithRespin_ds_NEXT=11.2.0.GA
...
#else
  version_parent_NEXT=4.5.2.Final-SNAPSHOT
  createBranch=false
  github_branch=master
  github_branch_fallback=master # or jbosstools-4.5.x?
#fi
TARGET_PLATFORM_VERSION_MIN=4.71.0.Final
TARGET_PLATFORM_VERSION_MAX=4.72.0.AM3-SNAPSHOT
