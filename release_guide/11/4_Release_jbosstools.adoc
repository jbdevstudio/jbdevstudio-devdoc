...
versionWithRespin_jbt_PREV=4.5.3.AM2 # previous RELEASED milestone as referenced in ide-config.properties
versionWithRespin_jbt=4.5.3.AM3
...
sprint_NEXT="devex #147 April 2018"
versionWithRespin_jbt=4.5.3.AM3
versionWithRespin_jbt_NEXT=4.5.3.Final
versionWithRespin_ds=11.3.0.AM3
versionWithRespin_ds_NEXT=11.3.0.GA
...
#else
  version_parent_NEXT=4.5.3.Final-SNAPSHOT
  createBranch=false
