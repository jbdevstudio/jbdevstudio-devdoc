...
version_jbt_PREV=4.5.0.Final # previous RELEASED milestone as referenced in ide-config.properties
version_jbt=4.5.1.AM3
version_jbt_NEXT=4.5.1.Final

version_ds_PREV_GA=11.0.0.GA
version_ds_PREV=11.0.0.GA # previous RELEASED milestone as referenced in ide-config.properties
version_ds=11.1.0.AM3
version_ds_NEXT=11.1.0.GA
...
* Update list of features, using content of http://download.jboss.org/jbosstools/static/oxygen/stable/updates/core/4.5.1.AM3/site.properties
...
sprint_NEXT="devex #139 October 2017"
versionWithRespin_jbt=4.5.1.AM3
versionWithRespin_jbt_NEXT=4.5.1.Final
versionWithRespin_ds=11.1.0.AM3
versionWithRespin_ds_NEXT=11.1.0.GA
...
#else
  version_parent_NEXT=4.5.1.Final-SNAPSHOT
  createBranch=false
