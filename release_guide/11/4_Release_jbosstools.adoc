...
# TODO JBIDE-24674 wrap this with a Jenkins job, using -A flag to automatically affect changes
python
/tmp/jbt.github/jbosstools-build-ci/util/checkUnresolvedIssues.py
  --jira https://issues.stage.jboss.org --jirauser ME --jirapwd SECRET \
