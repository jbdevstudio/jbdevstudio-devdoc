...
TARGET_PLATFORM_VERSION_MAXes="4.72.0.Final 4.71.1.Final"
...
versionWithRespin_jbt_PREV=4.5.2.Final # previous RELEASED milestone as referenced in ide-config.properties
versionWithRespin_jbt=4.5.3.AM1
...
sprint_NEXT="devex #145 February 2018"
versionWithRespin_jbt=4.5.3.AM1
versionWithRespin_jbt_NEXT=4.5.3.AM2
versionWithRespin_ds=11.3.0.AM1
versionWithRespin_ds_NEXT=11.3.0.AM2
...
for j in jbosstools-build.parent_${stream_jbt}; do
  ...
  nextJob=$(${JP} -s ${ccijenkins} -c $(jp-crumb) -j ${j} -t build -q); echo "[${nextJob}] ${ccijenkins}/${j} build"
  sleep 15s
...
#else
  version_parent_NEXT=4.5.3.AM1-SNAPSHOT
  createBranch=false
