...
for d in build build-ci build-sites devdoc discovery download.jboss.org maven-plugins versionwatch \
  aerogear arquillian base browsersim central forge fuse fuse-extras hibernate \
  integration-tests javaee jst livereload openshift server vpe webservices ; do # freemarker
  echo "====================================================================="
