...
https://dev-platform-jenkins-rhel7.rhev-ci-vms.eng.rdu2.redhat.com/view/Devstudio/view/jbosstools-releng/job/jbosstools-releng-push-to-dev-stable-02-copy-builds-and-rpms/
...
https://dev-platform-jenkins-rhel7.rhev-ci-vms.eng.rdu2.redhat.com/job/jbosstools-releng-push-to-dev-stable-07-notification-emails/configure
...
blogURL=/blog/4.5.0.am1-for-oxygen.0.html
pullrequestNum=709
eclipseVersionSuffix="" # TODO: use .1 for Eclipse 4.7.1 Oxygen.1
