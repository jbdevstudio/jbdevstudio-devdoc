...
wget http://wonka.mw.lab.eng.bos.redhat.com/rhd/devstudio/11/staging/builds/devstudio-${versionWithRespin_ds}-build-product/latest/all/
installerJar=$(cat index.html | grep -v latest | grep installer-standalone.jar\" | sed "s#.\+href=\"\([^\"]\+\)\">.\+#\1#")
echo "Installer jar: ${installerJar}"
rm -f index.html
time wget http://wonka.mw.lab.eng.bos.redhat.com/rhd/devstudio/11/staging/builds/devstudio-${versionWithRespin_ds}-build-product/latest/all/${installerJar}
