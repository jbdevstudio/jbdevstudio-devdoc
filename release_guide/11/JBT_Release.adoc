...
ccijenkins=https://dev-platform-jenkins-rhel7.rhev-ci-vms.eng.rdu2.redhat.com/job
...
https://dev-platform-jenkins-rhel7.rhev-ci-vms.eng.rdu2.redhat.com/view/Devstudio/view/jbosstools-releng/job/jbosstools-releng-push-to-dev-stable-02-copy-builds-and-update-sites/
...
https://dev-platform-jenkins-rhel7.rhev-ci-vms.eng.rdu2.redhat.com/view/Devstudio/view/jbosstools-releng/job/jbosstools-releng-push-to-dev-stable-03-verify-builds-update-sites/
...
https://dev-platform-jenkins-rhel7.rhev-ci-vms.eng.rdu2.redhat.com/view/Devstudio/view/jbosstools-releng/job/jbosstools-releng-push-to-dev-stable-04-update-merge-composites-html/
...
create a symlink from +/updates/webtools/neon+ to http://download.jboss.org/jbosstools/oxygen/stable/updates/ (or /development/updates/ if we're
...
https://dev-platform-jenkins-rhel7.rhev-ci-vms.eng.rdu2.redhat.com/view/Devstudio/view/jbosstools-releng/job/jbosstools-releng-push-to-dev-stable-05-release-target-platforms/
...
https://dev-platform-jenkins-rhel7.rhev-ci-vms.eng.rdu2.redhat.com/view/Devstudio/view/jbosstools-releng/job/jbosstools-releng-push-to-dev-stable-04-update-ide-config.properties/
...
versionWithRespin_jbt_PREV=4.4.4.Final
versionWithRespin_jbt=4.5.0.AM1d
versionWithRespin_jbt_NEXT=4.5.0.AM2

versionWithRespin_ds_PREV_GA=10.4.0.GA
versionWithRespin_ds_PREV=10.4.0.GA
versionWithRespin_ds=11.0.0.AM1d
...
[source,bash]
----
version_jbt_PREV_Mktplace=4.4.4.Final
version_jbt=4.5.0.AM1

# for Final releases only!
if [[ ${version_jbt} == *"Final" ]]; then
  cd /tmp
  wget -O ${version_jbt_PREV_Mktplace}.properties http://download.jboss.org/jbosstools/static/oxygen/development/updates/core/${version_jbt_PREV_Mktplace}/site.properties
...
# rebuild parent pom in master # jbosstools-4.5.0.x branch
# https://dev-platform-jenkins-rhel7.rhev-ci-vms.eng.rdu2.redhat.com/job/jbosstools-build.parent_master # jbosstools-4.5.x
...
JP=/tmp/jbt.github/jbosstools-build-ci/util/jenkinsPost.sh
stream_jbt=master
${JP} -s ${ccijenkins} -j jbosstools-build.parent_${stream_jbt} -t build
...
* https://dev-platform-jenkins-rhel7.rhev-ci-vms.eng.rdu2.redhat.com/view/Devstudio/view/jbosstools-releng/job/jbosstools-releng-push-to-staging-00-parent-pom-update-task-jiras/
