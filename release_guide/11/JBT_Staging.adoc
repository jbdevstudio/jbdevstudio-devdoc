...
versionWithRespin_jbt=4.5.0.AM1
versionWithRespin_ds=11.0.0.AM1
...
for j in jbosstools-buildflow-force-publish_${stream_jbt} jbosstools-buildflow_${stream_jbt} jbosstools-build.parent_${stream_jbt} \
    ...
    jbosstools-composite-install_${stream_jbt} jbosstools-browsersim-standalone_${stream_jbt} jbosstools-build-sites.aggregate.site_${stream_jbt} \
...
cd ~/tmp; wget http://download.eclipse.org/technology/epp/downloads/release/oxygen/M5/eclipse-jee-oxygen-M7-linux-gtk-x86_64.tar.gz &
# or
