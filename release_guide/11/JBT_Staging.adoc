...
Use dev90.hosts.mwqe.eng.bos.redhat.com (10.19.65.30) instead of www.qa.jboss.com (10.16.89.17) as can no longer ssh to hudson@www.qa
...
versionWithRespin_jbt=4.5.0.AM0
versionWithRespin_ds=11.0.0.AM0
versionWithRespin_ds_PREV=10.4.0.AM1
earlyaccess_IS=
...
versionWithRespin_jbt_PREV=4.4.4.AM1
versionWithRespin_jbt=4.5.0.AM0
...
* set correct github branch, eg., switch from 4.5.3.AM1x to 4.5.x
