...
TARGET_PLATFORM_CENTRAL_MAX=4.80.0.AM1-SNAPSHOT
...
cd ~/tmp; wget http://download.eclipse.org/technology/epp/downloads/release/photon/M6/eclipse-jee-photon-M6-linux-gtk-x86_64.tar.gz &
# or
...
versionWithRespin_jbt_PREV=4.5.3.Final # milestones
versionWithRespin_jbt=4.6.0.AM1
versionWithRespin_jbt_NEXT=4.6.0.AM2

versionWithRespin_ds_PREV_GA=11.3.0.GA
versionWithRespin_ds_PREV=11.3.0.GA # milestones
versionWithRespin_ds=12.0.0.AM1
versionWithRespin_ds_NEXT=12.0.0.AM2
