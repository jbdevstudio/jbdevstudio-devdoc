...
version_parent=4.6.0.Final-SNAPSHOT
versionWithRespin_jbt=4.6.0.Final
...
# else
  stream_jbt=master
# fi
TARGET_PLATFORM_VERSION_MAX=4.80.1.Final
TARGET_PLATFORM_CENTRAL_MAX=4.80.0.Final-SNAPSHOT
...
# or
cd ~/tmp; wget https://hudson.eclipse.org/packaging/job/photon.epp-tycho-build/lastSuccessfulBuild/artifact/org.eclipse.epp.packages/archive/20180614-1200_eclipse-jee-photon-RC4-linux.gtk.x86_64.tar.gz &
...
versionWithRespin_jbt_PREV=4.6.0.AM3 # milestones
versionWithRespin_jbt=4.6.0.Final
versionWithRespin_jbt_NEXT=4.9.0.AM1

versionWithRespin_ds_PREV_GA=11.3.0.GA
versionWithRespin_ds_PREV=12.0.0.AM3 # milestones
versionWithRespin_ds=12.0.0.GA
versionWithRespin_ds_NEXT=12.9.0.AM1
...
# else
  ...
  github_branch=master # later jbosstools-4.6.0.x
# fi
TARGET_PLATFORM_VERSION_MIN=4.80.1.Final
TARGET_PLATFORM_VERSION_MAX=4.80.1.Final
TARGET_PLATFORM_CENTRAL_MAX=4.80.0.Final-SNAPSHOT
respinSuffix=""
ccijenkins=https://dev-platform-jenkins.rhev-ci-vms.eng.rdu2.redhat.com/job
