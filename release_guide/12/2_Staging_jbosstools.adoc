...
version_parent=4.13.0.Final-SNAPSHOT
...
version_jbt_IS=4.12.0.Final
version_ds_IS=12.12.0.GA
...
versionWithRespin_ds_PREV=12.13.0.AM1 # milestones
versionWithRespin_ds=12.13.0.GA
...
stream_jbt=master
github_branch=master
TARGET_PLATFORM_VERSION_MIN=4.13.0.Final-SNAPSHOT
TARGET_PLATFORM_VERSION_MAX=4.13.0.Final-SNAPSHOT
TARGET_PLATFORM_CENTRAL_MAX=4.13.0.Final-SNAPSHOT
respinSuffix=""
ccijenkins=https://dev-platform-jenkins.rhev-ci-vms.eng.rdu2.redhat.com/job
