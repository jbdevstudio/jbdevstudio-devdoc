...
version_parent=4.9.0.Final-SNAPSHOT
...
# or
cd ~/tmp; wget https://hudson.eclipse.org/packaging/job/simrel.epp-tycho-build/lastSuccessfulBuild/artifact/org.eclipse.epp.packages/archive/20180809-1157_eclipse-jee-2018-09-M2-linux.gtk.x86_64.tar.gz &
...
versionWithRespin_ds_PREV=12.9.0.AM3 # milestones
versionWithRespin_ds=12.9.0.GA
...
stream_jbt=master
github_branch=master
TARGET_PLATFORM_VERSION_MIN=4.9.0.Final-SNAPSHOT
TARGET_PLATFORM_VERSION_MAX=4.9.0.Final-SNAPSHOT
TARGET_PLATFORM_CENTRAL_MAX=4.9.0.Final-SNAPSHOT
respinSuffix=""
ccijenkins=https://dev-platform-jenkins.rhev-ci-vms.eng.rdu2.redhat.com/job
