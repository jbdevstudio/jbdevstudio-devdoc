...
version_parent=4.9.0.AM1-SNAPSHOT
...
version_ds=$(echo ${versionWithRespin_ds} | sed -e '/[abcdwxyz]$/ s/\(^.*\)\(.$\)/\1/') # ***
stream_jbt=master
TARGET_PLATFORM_VERSION_MAX=4.9.0.AM2-SNAPSHOT
TARGET_PLATFORM_CENTRAL_MAX=4.9.0.AM2-SNAPSHOT
...
versionWithRespin_jbt_PREV=4.9.0.AM1 # milestones
versionWithRespin_jbt=4.9.0.AM2
versionWithRespin_jbt_NEXT=4.9.0.AM3

versionWithRespin_ds_PREV_GA=12.0.0.GA
versionWithRespin_ds_PREV=12.9.0.AM1 # milestones
versionWithRespin_ds=12.9.0.AM2
...
stream_jbt=master
github_branch=master
TARGET_PLATFORM_VERSION_MIN=4.9.0.AM2-SNAPSHOT
TARGET_PLATFORM_VERSION_MAX=4.9.0.AM2-SNAPSHOT
TARGET_PLATFORM_CENTRAL_MAX=4.9.0.AM2-SNAPSHOT
respinSuffix=""
ccijenkins=https://dev-platform-jenkins.rhev-ci-vms.eng.rdu2.redhat.com/job
