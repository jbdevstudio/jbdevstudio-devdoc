...
jpcrumb=$(wget -q --auth-no-challenge --user KER_USER --password KERB_PWD --output-document - "${ccijenkins//\/job/}/crumbIssuer/api/xml?xpath=//crumb" | sed "s#<crumb>\([0-9a-f]\+\)</crumb>#\1#")
