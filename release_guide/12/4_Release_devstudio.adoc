...
# devstudio-12.13.0.GA-target-platform-central.zip
# devstudio-12.13.0.GA-target-platform.zip
# devstudio-12.13.0.GA-updatesite-core.zip
...
blogURL=/blog/12.13.0.ga.html
# Pull Request (PR)
pullrequestNum=897
eclipseVersionSuffix=".R" # TODO: use .M1 for Eclipse 4.9.M1
GOLIVEDATE="2019-11-06"

versionWithRespin_jbt=4.13.0.Final #Final
versionWithRespin_ds=12.13.0.GA #GA
