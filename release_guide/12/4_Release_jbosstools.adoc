...
versionWithRespin_jbt_PREV=4.5.3.Final # previous RELEASED milestone as referenced in ide-config.properties
versionWithRespin_jbt=4.6.0.AM1
...
* Update list of features, using content of http://download.jboss.org/jbosstools/static/photon/stable/updates/core/4.5.2.Final/site.properties

To diff if any new features have been added/removed:

[source,bash]
----
version_jbt_PREV_Mktplace=4.5.3.Final
...
sprint_NEXT="devex #149 May 2018"
versionWithRespin_jbt=4.6.0.AM1
versionWithRespin_jbt_NEXT=4.6.0.AM2
versionWithRespin_ds=12.0.0.AM1
versionWithRespin_ds_NEXT=12.0.0.AM2
