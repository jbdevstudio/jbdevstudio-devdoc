...
versionWithRespin_jbt=4.9.0.AM3
versionWithRespin_ds=12.9.0.AM3
version_jbt=$(echo ${versionWithRespin_jbt} | sed -e '/[abcdwxyz]$/ s/\(^.*\)\(.$\)/\1/') # ***
version_ds=$(echo ${versionWithRespin_ds} | sed -e '/[abcdwxyz]$/ s/\(^.*\)\(.$\)/\1/') # ***
stream_jbt=master
stream_ds=master
TARGET_PLATFORM_VERSION_MAX=4.9.0.AM3-SNAPSHOT
...
versionWithRespin_jbt_PREV=4.9.0.AM2 # milestones
versionWithRespin_jbt=4.9.0.AM3
versionWithRespin_jbt_NEXT=4.9.0.Final
...
versionWithRespin_ds=12.9.0.AM3
versionWithRespin_ds_NEXT=12.9.0.GA
...
* http://download.jboss.org/jbosstools/static/photon/development/updates/core/4.9.0.AM2/site.properties
...
sprint_NEXT="devex #155 September 2018"
versionWithRespin_jbt=4.9.0.AM3
versionWithRespin_jbt_NEXT=4.9.0.Final
versionWithRespin_ds=12.9.0.AM3
versionWithRespin_ds_NEXT=12.9.0.GA
...
#  github_branch_fallback=master
  ...
  github_branch_fallback=master
#fi
TARGET_PLATFORM_VERSION_MIN=4.9.0.AM3-SNAPSHOT # TODO remove this variable - no longer needed
TARGET_PLATFORM_VERSION_MAX=4.9.0.AM3-SNAPSHOT
