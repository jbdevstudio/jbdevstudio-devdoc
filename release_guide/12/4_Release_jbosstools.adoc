...
TARGET_PLATFORM_VERSION_MAXes="4.80.1.Final" # space separated list if more than one to release
...
[source,bash]
----
version_jbt_PREV_Mktplace=4.6.0.AM3
...
sprint_NEXT="devex #152 July 2018"
versionWithRespin_jbt=4.6.0.Final
versionWithRespin_jbt_NEXT=4.9.0.AM1
versionWithRespin_ds=12.0.0.GA
versionWithRespin_ds_NEXT=12.9.0.AM1
...
#else
  version_parent_NEXT=4.9.0.AM1-SNAPSHOT
  createBranch=false
