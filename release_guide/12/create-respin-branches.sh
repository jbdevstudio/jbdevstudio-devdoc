...
versionWithRespin_jbt=4.21.2.GA
versionWithRespin_ds_PREV=12.21.0.GA
versionWithRespin_ds=12.21.2.GA

for i in base central discovery forge fuse hibernate javaee jst livereload openshift quarkus server vpe webservices
do
...
git checkout -b ${versionWithRespin_ds}
git push origin ${versionWithRespin_ds}:${versionWithRespin_ds}
cd ..
