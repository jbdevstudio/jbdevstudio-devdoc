...
Use:
  ...
  * http://download.jboss.org/jbosstools/updates/ +
  and
  * http://download.jjirboss.org/jbosstools/static/targetplatforms/ instead of 
...
== Check if release in Jira is ready
...
Should not continue doing release if there are any jira issues left. Only jiras allowed before release should be bookeping jiras or somehow
agreed to be done during actual push of binaries.
...
____
*To* external-exadel-list@redhat.com, release-engineering@redhat.com +
and +
