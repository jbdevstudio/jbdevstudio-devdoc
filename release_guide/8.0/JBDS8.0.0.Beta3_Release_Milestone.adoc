...
version=8.0.0.Beta3
versionWithRespin=8.0.0.Beta3b; # a, b, c, ...
...
[source,bash]
----
jboss.discovery.directory.url|devstudio|8.0.0.Beta3=https://devstudio.jboss.com/updates/8.0-development/devstudio-directory.xml
jboss.discovery.site.url|devstudio|8.0.0.Beta3=https://devstudio.jboss.com/updates/8.0-development/central/core/
----
