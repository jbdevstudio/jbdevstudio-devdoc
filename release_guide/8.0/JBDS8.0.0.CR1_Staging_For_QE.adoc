...
rsync -aPrz --rsh=ssh --protocol=28 /tmp/jboss-devstudio-${version}-updatesite-central ${JBDS}/updates/8.0.0/
...
rsync -aPrz --rsh=ssh --protocol=28 /tmp/jboss-devstudio-${version}-updatesite-earlyaccess ${JBDS}/updates/8.0.0/
