...
Thus, using this regex - s#-v\d{8}-\d{4}-B\d+## - we would rename as follows:
  ...
  jboss-devstudio-8.0.0.GA-v20141020-1042-B317-installer-standalone.jar

to

  jboss-devstudio-8.0.0.GA-installer-standalone.jar 
...
and +
*To* gss-support-readiness@redhat.com, dgeoffro@redhat.com, mmusaji@redhat.com (for GA releases ONLY)
