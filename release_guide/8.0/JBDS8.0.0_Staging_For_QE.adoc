...
[sources,bash]
----
versionWithRespin=8.0.1.CR2
TARGET_PLATFORM_VERSION_MAX=4.41.1.CR2
CENTRAL_TARGET_VERSION=4.41.1.CR1-SNAPSHOT
previousFull=8.0.1.CR1
now=$(date +%s000)
isGA=false
...
versionWithRespin=8.0.1.CR2 # a, b, c...
...
oldTP=jboss-devstudio-8.0.1.CR1
newTP=jboss-devstudio-${versionWithRespin}
# Example for a respin
# oldTP=jboss-devstudio-8.0.1.CR1
# newTP=jboss-devstudio-8.0.1.CR1
...
# rememeber to include IS jar in devstudio-directory.xml
isjar=""
...
if [[ ${isjar} ]]; then 
  ...
  if [[ ! ${isjar2} ]]; then
    ...
    echo "devstudio-directory.xml includes ${isjar}" | grep integration-stack
  fi
fi
...
jboss.discovery.directory.url|devstudio|8.0.1.CR1=https://devstudio.redhat.com/updates/8.0-staging/devstudio-directory.xml
jboss.discovery.site.url|devstudio|8.0.1.CR1=https://devstudio.redhat.com/updates/8.0-staging/
jboss.discovery.earlyaccess.site.url|devstudio|8.0.1.CR1=https://devstudio.redhat.com/earlyaccess/8.0-staging/
----
...
wget -nc -q --no-check-certificate https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_8.0.luna/job/jbosstools-discovery_4.2.luna/ws/sources/jbdevstudio/com.jboss.jbds.central.discovery.earlyaccess/devstudio-earlyaccess.properties
...
jbdsVersion=8.0.1.CR1 # no respin suffix here
jbtVersion=4.2.1.CR1 # no respin suffix here
echo "
Subject: 
