...
if [ "$isFinal" = true ]; then
  ...
  for newJar in ${newJarEA} ${newJarCore}; do
    ...
    sed -i "s#http://download.jboss.org/jbosstools/updates/staging/luna/central/core/#http://download.jboss.org/jbosstools/updates/stable/${eclipseTrain}/#g" plugin.xml
    sed -i "s#http://download.jboss.org/jbosstools/updates/development/luna/central/core/#http://download.jboss.org/jbosstools/updates/stable/${eclipseTrain}/#g" plugin.xml
    sed -i "s#http://download.jboss.org/jbosstools/updates/stable/luna/central/core/#http://download.jboss.org/jbosstools/updates/stable/${eclipseTrain}/#g" plugin.xml
  ...
  for newJar in ${newJarEA} ${newJarCore}; do
    ...
    sed -i "s#http://download.jboss.org/jbosstools/updates/development/luna/central/core/#http://download.jboss.org/jbosstools/updates/development/${eclipseTrain}/#g" plugin.xml
