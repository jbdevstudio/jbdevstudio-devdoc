...
Then verify the discovery sites are correctly populated: directory.xml contains right entries, and plugins/ folder contains the expected 
jars according to discovery.xml
