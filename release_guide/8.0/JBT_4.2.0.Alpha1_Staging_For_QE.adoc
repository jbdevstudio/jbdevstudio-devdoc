...
Update the discovery job on *branch* ( https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_8.0.luna/job/jbosstools-discovery_42/configure ) to publish to the right URL, according to JBT and JBDS versions::
* Update property +JBT_UPDATE_SITE+ to http://download.jboss.org/jbosstools/updates/JBossTools-4.2.0.Alpha1.core/
* Update property +JBDE_UPDATE_SITE+ to http://www.qa.jboss.com/binaries/RHDS/updates/development/8.0.0.Alpha1.core/
...
. *Core* site (which contains JBoss Tools): Move the most recent build available from +http://downloads.jboss.org/tools/build/nightly/core/4.2.luna+ to +http://downloads.jboss.org/tools/development/4.2.0.Alpha1.core/+
. *Core Tests* site (which contains JBoss Tools tests): Move the most recent build available from +http://downloads.jboss.org/tools/build/nightly/coretests/4.2.luna+ to +http://downloads.jboss.org/tools/development/4.2.0.Alpha1.coretests/+
. *WebTools* site (which contains only WTP connectors for AS/WildFly/EAP): Move the most recent build available from +http://downloads.jboss.org/tools/build/nightly/webtools/4.2.luna+ to +http://downloads.jboss.org/tools/development/4.2.0.Alpha1.webtools/+ 
...
*Subject* JBoss Tools Core 4.2.0.Alpha1 bits available for QE testing +
*Body*
----
JBoss Tools Core 4.2.0.Alpha1 bits available for QE testing
