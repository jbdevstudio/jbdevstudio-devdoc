...
versionWithRespin=4.2.0.jbosstools-4.2.0.Beta3b # Fully qualified version, including respin suffix
hibernateToolsVersionWithRespin=4.2.0.Beta3b #it is possible that hibernate tools didn't require the same # of respins, so might have a different version
...
----
  version=4.2.0.Beta3
  versionWithRespin=4.2.0.Beta3b # a, b, c, d...
  TOOLS=tools@filemgmt.jboss.org:/downloads_htdocs/tools
...
versionWithRespin=4.2.0.Beta3b
eclipseTrain=luna
TOOLS=tools@filemgmt.jboss.org:/downloads_htdocs/tools
...
version=4.2.0.Beta3 # name to use in filenames ie fixVersion in JIRA
versionWithRespin=4.2.0.Beta3b # Fully qualified version, including respin suffix
...
# replace existing lines with these to make the 4.2.0.Beta3b stuff live
