...
* Update the job to set the correct respin label ("" for a first build, "a" or "b" for subsequent respins):

https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_8.0.luna/job/jbosstools-centraltarget_4.2.luna/configure

* Run the job and verify that it publishes to the correct folder, eg. with "b",

http://download.jboss.org/jbosstools/targetplatforms/jbtcentraltarget/4.40.0.Beta4b-SNAPSHOT/
http://download.jboss.org/jbosstools/targetplatforms/jbtearlyaccesstarget/4.40.0.Beta4b-SNAPSHOT/
...
* Update property +JBT_UPDATE_SITE+ to http://download.jboss.org/jbosstools/updates/staging/jbosstools-4.2.0.Beta3b-updatesite-core/
* Update property +JBDS_UPDATE_SITE+ to http://www.qa.jboss.com/binaries/RHDS/updates/development/8.0.0.Beta3b-updatesite-core/
...
jboss.discovery.directory.url|jbosstools|4.2.0.Beta3=http://download.jboss.org/jbosstools/discovery/development/4.2.0.Beta3b/jbosstools-directory.xml
jboss.discovery.site.url|jbosstools|4.2.0.Beta3=http://download.jboss.org/jbosstools/discovery/development/4.2.0.Beta3b/
jboss.discovery.earlyaccess.site.url|jbosstools|4.2.0.Beta3=http://download.jboss.org/jbosstools/discovery/development/4.2.0.Beta3b/

# commit the change and push to master
ci "release JBT 4.2.0.Beta3b to QE: link to latest dev milestone discovery site" ide-config.properties
gw2; gw3; gw4
