...
* Update property +JBT_UPDATE_SITE+ to http://download.jboss.org/jbosstools/updates/staging/jbosstools-4.2.0.Beta3-updatesite-core/
* Update property +JBDS_UPDATE_SITE+ to http://www.qa.jboss.com/binaries/RHDS/updates/development/8.0.0.Beta3-updatesite-core/
...
ci "release JBT 4.2.0.Beta3 to QE: link to latest dev milestone discovery site" ide-config.properties
gw2; gw3; gw4
