...
jboss.discovery.directory.url|jbosstools|4.2.0.Beta3=http://download.jboss.org/jbosstools/discovery/development/4.2.0.Beta3c/jbosstools-directory.xml
jboss.discovery.site.url|jbosstools|4.2.0.Beta3=http://download.jboss.org/jbosstools/discovery/development/4.2.0.Beta3c/
jboss.discovery.earlyaccess.site.url|jbosstools|4.2.0.Beta3=http://download.jboss.org/jbosstools/discovery/development/4.2.0.Beta3c/

# commit the change and push to master
ci "release JBT 4.2.0.Beta3c to QE: link to latest dev milestone discovery site" ide-config.properties
gw2; gw3; gw4
