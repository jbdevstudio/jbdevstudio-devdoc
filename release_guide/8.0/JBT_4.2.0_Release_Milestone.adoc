...
For Final or GA releases, the target platform folders should be moved to /static/ and symlinked back.

Thus for example, 

http://download.jboss.org/jbosstools/targetplatforms/jbosstoolstarget/4.40.0.Final/
http://download.jboss.org/jbosstools/targetplatforms/jbosstoolstarget/4.41.0.Final/
http://download.jboss.org/jbosstools/targetplatforms/jbdevstudiotarget/4.40.0.Final/
http://download.jboss.org/jbosstools/targetplatforms/jbdevstudiotarget/4.41.0.Final/

should be moved to:

http://download.jboss.org/jbosstools/static/targetplatforms/jbosstoolstarget/4.40.0.Final/
http://download.jboss.org/jbosstools/static/targetplatforms/jbosstoolstarget/4.41.0.Final/
http://download.jboss.org/jbosstools/static/targetplatforms/jbdevstudiotarget/4.40.0.Final/
http://download.jboss.org/jbosstools/static/targetplatforms/jbdevstudiotarget/4.41.0.Final/

Then you can symlink the old location to the new one.

1. Create 4 relative-path symlinks on your local disk, like this:

[source,bash]
----
cd /path/to/jbosstools-download.jboss.org/jbosstools/targetplatforms/jbosstoolstarget
ln -s ../../static/targetplatforms/jbosstoolstarget/4.40.0.Final
ln -s ../../static/targetplatforms/jbosstoolstarget/4.41.0.Final
cd ../jbdevstudiotarget
ln -s ../../static/targetplatforms/jbdevstudiotarget/4.40.0.Final
ln -s ../../static/targetplatforms/jbdevstudiotarget/4.41.0.Final
----

2. Push those files to github:

https://github.com/jbosstools/jbosstools-download.jboss.org/pull/429

3. scp/sftp/rsync these link files to the server, where they will act as symlinks
