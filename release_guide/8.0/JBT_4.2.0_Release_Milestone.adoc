...
URL="https://issues.jboss.org/secure/ConfigureReport.jspa?versions=12325569&versions=12323830&sections=all&style=html&selectedProjectId=10020&reportKey=org.jboss.labs.jira.plugin.release-notes-report-plugin%3Areleasenotes&Next=Next"
...
wget http://download.jboss.org/jbosstools/builds/development/jbosstools-4.2.0.Final-browsersim-standalone/jbosstools-4.2.0.Final-browsersim-standalone.zip -O $z
...
firefox \
view-source:http://download.jboss.org/jbosstools/targetplatforms/jbosstoolstarget/4.41.0.Final/compositeContent.xml \
view-source:http://download.jboss.org/jbosstools/targetplatforms/jbosstoolstarget/4.41.0.Final/REPO/compositeContent.xml \
view-source:http://download.jboss.org/jbosstools/targetplatforms/jbdevstudiotarget/4.41.0.Final/compositeContent.xml \
view-source:http://download.jboss.org/jbosstools/targetplatforms/jbdevstudiotarget/4.41.0.Final/REPO/compositeContent.xml \
http://download.jboss.org/jbosstools/static/targetplatforms/jbosstoolstarget/4.41.0.Final/ \
http://download.jboss.org/jbosstools/static/targetplatforms/jbdevstudiotarget/4.41.0.Final/
...
[source,bash]
----
discoveryTPVersion=4.41.0.Final-SNAPSHOT #version for ongoing release
nextVersion=4.41.1.Alpha1-SNAPSHOT #next version on that stream
...
# TODO: replace any leftover references to http://download.jboss.org/jbosstools/updates/development/luna/central/core/ with http://download.jboss.org/jbosstools/updates/development/luna/
# TODO: replace any leftover references to http://download.jboss.org/jbosstools/updates/stable/luna/central/core/ with http://download.jboss.org/jbosstools/updates/stable/luna/

# TODO: IMPORTANT! Make sure no integration stack entries are accidentally lost in jbosstools-directory.xml or jbosstools-earlyaccess.properties

----

When all changes are done:

* Commit them (should show 3 files changed, plus 2 jars add and 2 (or more) jars deleted)
* Push to remote repo
* Publish to download.jboss.org using the synchronization job https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_Master/job/jbosstools-download.jboss.org-rsync-from-git/
...
* Ff this is a Final release, CAREFULLY merge stuff in /development/ over to /stable/, taking into account where files SHOULD be different (eg., where a page is called "Stable Release" instead of "Development Milestone")
...
----
version=4.2.0.Final
eclipseVersion="Eclipse 4.4.1 Luna SR1"
echo "
Subject: 
