...
theversion=`unzip -p ${thejar} */currentversion.properties | grep default.version | sed -e "s/default.version=//"`
rm -f ${thejar}
echo $theversion
...
jboss.discovery.directory.url|jbosstools|4.2.0.Final=http://download.jboss.org/jbosstools/discovery/staging/4.2.0.Final/jbosstools-directory.xml
jboss.discovery.site.url|jbosstools|4.2.0.Final=http://download.jboss.org/jbosstools/updates/staging/luna/
jboss.discovery.earlyaccess.site.url|jbosstools|4.2.0.Final=http://download.jboss.org/jbosstools/discovery/staging/4.2.0.Final/
jboss.discovery.earlyaccess.list.url|jbosstools|4.2.0.Final=http://download.jboss.org/jbosstools/discovery/staging/4.2.0.Final/jbosstools-earlyaccess.properties
...
TARGET_PLATFORM_VERSION_MAX=4.41.1.CR1
TARGET_PLATFORM_CENTRAL_MAX=4.41.1.CR1-SNAPSHOT
