...
(http://download.jboss.org/jbosstools/targetplatforms/jbtcentraltarget/4.41.0.CR2-SNAPSHOT/ and http://download.jboss.org/jbosstools/targetplatforms/jbtearlyaccesstarget/4.41.0.CR2-SNAPSHOT/ ) now
...
# Install all content from http://download.jboss.org/jbosstools/updates/staging/luna in it
# Restart as suggested
# Open Central Software/Updates tab, enable Early-Access select and install all connectors
# Restart as suggested
