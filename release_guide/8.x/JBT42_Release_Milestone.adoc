...
----
stream=4.2.luna
version=4.2.3.Beta1 # name to use in filenames ie fixVersion in JIRA
versionWithRespin=4.2.3.Beta1 # Fully qualified version, including respin suffix
hibernateToolsVersionWithRespin=4.2.3.Beta1 # it is possible that hibernate tools didn't require the same # of respins, so might have a different version
...
wget http://download.jboss.org/jbosstools/builds/development/jbosstools-4.2.3.Beta1-browsersim-standalone/jbosstools-4.2.3.Beta1-browsersim-standalone.zip -O $z
...
----
version=4.2.3.Beta1
versionWithRespin=4.2.3.Beta1 # no respin suffix or a, b, c, d... suffix
TOOLS=tools@filemgmt.jboss.org:/downloads_htdocs/tools
...
So if you're doing a 4.2.3.Beta1, then you can delete 4.2.Beta1a, etc. folders. A graphical sftp client such as FileZilla or FireFTP (plugin for Firefox) is the easiest way to perform these operations. Looks in the following locations:
...
oldTP=4.41.2.Final
newTP=4.42.0.Beta1 # no -SNAPSHOT suffix here, as we'll remove it as we move to /static/
...
[source,bash]
----
discoveryTP_prev=4.41.2.Final-SNAPSHOT #version for ongoing release
discoveryTP_next=4.42.0.Beta1-SNAPSHOT #next version on that stream
JBT_prev=updates/staging/luna/jbosstools-4.2.3.Beta1-updatesite-core
JBT_next=static/releases/jbosstools-4.2.3.Beta1-updatesite-core
...
# remove existing lines with these to make the 4.2.3.Beta1 stuff live as the lastest for 4.2.3 in development/luna
#jboss.discovery.directory.url|jbosstools|4.2.3.Beta1=http://download.jboss.org/jbosstools/discovery/development/4.2.3.Beta1/jbosstools-directory.xml
#jboss.discovery.site.url|jbosstools|4.2.3.Beta1=http://download.jboss.org/jbosstools/discovery/development/4.2.3.Beta1/
#jboss.discovery.earlyaccess.site.url|jbosstools|4.2.3.Beta1=http://download.jboss.org/jbosstools/discovery/development/4.2.3.Beta1/
...
WARNING: Only for Beta, CR and GA! We do not release Alphas to Eclipse Marketplace, nor maintenance milestones like 4.2.y.Beta1 while 4.2.x is live in /stable/.

=== If node does not yet exist

This is usually the case of first Beta version.

Create a new node on Marketplace, use content of +http://download.jboss.org/jbosstools/static/releases/jbosstools-4.2.3.Beta1-updatesite-core/site.properties+
...
* Update list of features, using content of +http://download.jboss.org/jbosstools/static/releases/jbosstools-4.2.3.Beta1-updatesite-core/site.properties+
...
tagName=jbosstools-4.2.3.Beta1
echo "
Subject:
