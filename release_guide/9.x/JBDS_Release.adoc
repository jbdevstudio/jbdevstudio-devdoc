...
* Attach a pull request for https://github.com/jboss-developer/www.jboss.org/blob/master/products/devstudio/_common/product.yml 
...
version=9.0.0.Beta1
versionWithRespin=9.0.0.Beta1c
JBDS=devstudio@filemgmt.jboss.org:www_htdocs/devstudio
...
version=9.0.0.Beta1c # name to use in filenames ie fixVersion in JIRA
versionWithRespin=9.0.0.Beta1c # Fully qualified version, including respin suffix
