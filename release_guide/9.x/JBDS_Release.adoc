...
`jboss-devstudio-9.0.0.CR1-v20141020-1042-B317-installer-standalone.jar` must be renamed to `jboss-devstudio-9.0.0.CR1-installer-standalone.jar`.
...
* Past example: https://issues.jboss.org/browse/DEVELOPER-1403, https://issues.jboss.org/browse/DEVELOPER-1371
...
[1] https://access.redhat.com/jbossnetwork/restricted/listSoftware.html?downloadType=distributions&product=jbossdeveloperstudio&version=9.0.0.CR1
...
As an answer, you get the links to the GoldenGate files, eg., /content/origin/files/sha256/2c/2c92b68d122db901e3acbb74f06950116f4fe29402c25f4391761f9a93e65bba/jboss-devstudio-9.0.0.CR1-updatesite-core.zip
...
# copy 6 zips & SHAs
# jboss-devstudio-9.0.0.CR1a-target-platform-central.zip           jboss-devstudio-9.0.0.CR1a-target-platform.zip          jboss-devstudio-9.0.0.CR1a-updatesite-core.zip
# jboss-devstudio-9.0.0.CR1a-target-platform-earlyaccess.zip       jboss-devstudio-9.0.0.CR1a-updatesite-central.zip       jboss-devstudio-9.0.0.CR1a-updatesite-earlyaccess.zip
version=9.0.0.CR1
versionWithRespin=9.0.0.CR1a # a, b, c...
...
for site in site central-site earlyaccess-site; do
  if [[ ${site} == "site" ]]; then sitename="core"; else sitename=${site/-site/}; fi
  echo "https://devstudio.redhat.com/9.0/development/updates/${sitename}/${version}/ " >> $tmpfile
done
...
# zip & installers
echo "https://devstudio.redhat.com/9.0/development/updates/core/#_____(6_zips_+_SHAs,_and_${version}_folder) " >> $tmpfile
echo "https://devstudio.redhat.com/9.0/development/builds/installer/${version}/ " >> $tmpfile
echo "" >> $tmpfile
cat $tmpfile
firefox `cat $tmpfile`
rm -fr $tmpfile
...
rm -f composite*.xml
wget https://devstudio.redhat.com/9.0/development/updates/discovery.earlyaccess/9.0.0.CR1/compositeContent.xml
wget https://devstudio.redhat.com/9.0/development/updates/discovery.earlyaccess/9.0.0.CR1/compositeArtifacts.xml
echo "------------"
egrep "staging|development|${version}|${versionWithRespin}" compositeContent.xml
popd >/dev/null
...
* https://github.com/jbosstools/jbosstools-website/pull/489 (JBDS CR1)
