...
rsync -aPrz --rsh=ssh --protocol=28 ${JBDS}/9.0/staging/updates/discovery.central/9.0.0.Beta1/composite*xml ./
...
rsync -aPrz --rsh=ssh --protocol=28 ./composite*xml ${JBDS}/9.0/staging/updates/discovery.central/9.0.0.Beta1/
