...
echo "https://devstudio.redhat.com/9.0/staging/builds/ (5 folders w/ ${versionWithRespin}) *AND* https://devstudio.redhat.com/9.0/staging/updates/core/ (12 zips, 12 sums, 1 folder w/ ${versionWithRespin})"
...
version=9.0.0.Beta2
versionWithRespin_PREV=9.0.0.Beta2a # a, b, c...
versionWithRespin=9.0.0.Beta2b # a, b, c...
TARGET_PLATFORM_VERSION_MAX=4.50.0.Beta2
CENTRAL_TARGET_VERSION=4.50.0.Beta2-SNAPSHOT
