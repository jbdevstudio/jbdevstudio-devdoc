...
if [[ $ID ]]; then
  ...
  # copy build folder
  mkdir -p /qa/services/http/binaries/RHDS/9.0/staging/builds/devstudio-${versionWithRespin}-build-product/${ID}/ --exclude="repo"
...
version=9.1.0.Beta2
versionWithRespin_PREV=9.1.0.Beta2 # a, b, c...
versionWithRespin=9.1.0.Beta2a # a, b, c...
TARGET_PLATFORM_VERSION_MAX=4.52.0.Beta2-SNAPSHOT
TARGET_PLATFORM_CENTRAL_MAX=4.52.0.Beta2-SNAPSHOT
