...
# TODO replace this with a simply copy of content from /staging/ to /development/ like we do for JBDS.
# TODO remove need for _PREV variables
...
version=4.3.1.Beta2
versionWithRespin=4.3.1.Beta2a # a, b, c...
TARGET_PLATFORM_VERSION_MAX=4.51.2.Beta2-SNAPSHOT
TARGET_PLATFORM_CENTRAL_MAX=4.51.0.Beta2-SNAPSHOT
