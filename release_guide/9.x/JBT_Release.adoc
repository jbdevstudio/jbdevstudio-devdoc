...
stream=4.3.mars
version=4.3.0.Beta1 # name to use in filenames ie fixVersion in JIRA
versionWithRespin=4.3.0.Beta1c # a, b, c... # Fully qualified version, including respin suffix
...
for site in core; do
  ...
  rsync -aPrz --rsh=ssh --protocol=28 tools@filemgmt.jboss.org:/downloads_htdocs/tools/mars/staging/updates/${site}/${versionWithRespin}/* ${tmpdir}/
  # copy update site
...
scp core/composite*.xml core/index.html tools@filemgmt.jboss.org:/downloads_htdocs/tools/mars/development/updates/core/
...
#TODO: https://issues.jboss.org/browse/JBIDE-19757 should we just point the symlink at ../../static/mars/development/updates/core/${version}
pushd jbosstools-download.jboss.org/jbosstools/updates/webtools
  # create new symlink
  mv mars mars_${previous}
  ln -s ../../static/mars/development/updates/webtools/${version} mars
  # move the previous release out of the way
  echo "rename webtools/${eclipseTrain} webtools/${eclipseTrain}_${previous}" | sftp ${TOOLS}/updates/ #formatting_glitch_
...
http://download.jboss.org/jbosstools/updates/webtools/${eclipseTrain}"
...
oldTP=4.50.0.Alpha2
newTP=4.50.0.Beta1  # no -SNAPSHOT suffix here
now=`date +%s000`
eclipseTrain=mars
TOOLS=tools@filemgmt.jboss.org:/downloads_htdocs/tools
...
# TODO: should we copy *.xml and *.properties under 4.3.0.Beta1/ folders into ../ ?
# jboss.discovery.directory.url|jbosstools|4.3=http://download.jboss.org/jbosstools/mars/development/updates/discovery.central/4.3.0.Beta1/jbosstools-directory.xml
...
# jboss.discovery.earlyaccess.list.url|jbosstools|4.3=http://download.jboss.org/jbosstools/mars/development/updates/earlyaccess/4.3.0.Beta1/jbosstools-earlyaccess.properties
...
blogURL=/blog/2015-06-22-beta1-for-mars.html
echo "
Subject: 
