...
Then select the target release (4.3.0.Beta2 for example), type of issues = "All", style = "HTML". Copy the URL of the report page below.
...
# Do these 3 steps in parallel to save time
...
Create a new node on Marketplace, use content of +http://download.jboss.org/jbosstools/static/releases/jbosstools-4.3.0.Beta2-updatesite-core/site.properties+
...
* Update list of features, using content of +http://download.jboss.org/jbosstools/static/releases/jbosstools-4.3.0.Beta2-updatesite-core/site.properties+
