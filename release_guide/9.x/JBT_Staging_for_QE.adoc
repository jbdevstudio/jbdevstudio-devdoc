...
VERSION=Beta1a # a, b, c... (not SNAPSHOT!) 
...
[source,bash]
----
versionWithRespin_PREV=4.3.1.Beta1 # a, b, c...
...
version=4.3.1.Beta1
versionWithRespin=4.3.1.Beta1a # a, b, c...
jbdsFixVersion=9.1.0.Beta1 # no respin suffix here
jbdsFixVersionWithRespin=9.1.0.Beta1a # a, b, c...
...
* re-enable jobs that were disabled above
...
versionWithRespin=4.3.1.Beta1a # a, b, c...
respin="respin-a"
TARGET_PLATFORM_VERSION_MIN=4.50.2.Beta1-SNAPSHOT
TARGET_PLATFORM_VERSION_MAX=4.51.2.Beta1-SNAPSHOT
TARGET_PLATFORM_CENTRAL_MAX=4.51.0.Beta1-SNAPSHOT
jbdsFixVersion=9.1.0.Beta1 # no respin suffix here
jbtFixVersion=4.3.1.Beta1 # no respin suffix here
echo "
Subject: 
