...
for site in site; do
  ...
  if [[ $ID ]]; then
    ...
    tmpdir=/tmp/jbosstools-staging__${site}_${stream}__${ID}
...
# make sure 
# copy JBT discovery sites to staging/builds/ and staging/updates/
TOOLS=tools@filemgmt.jboss.org:/downloads_htdocs/tools
...
echo "DONE: copy JBT discovery sites to staging/builds/ and staging/updates/" | grep "copy JBT discovery sites to staging/builds/ and staging/updates/"
