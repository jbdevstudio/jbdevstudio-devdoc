...
VERSION=Beta2a # a, b, c... (not SNAPSHOT!)
...
@Since JBT 4.3.0.Beta2 / JBDS 9.0.Beta2
...
[source,bash]
----
versionWithRespin_PREV=4.3.1.Beta2 # a, b, c...
...
version=4.3.1.Beta2
versionWithRespin=4.3.1.Beta2a # a, b, c...
jbdsFixVersion=9.1.0.Beta2 # no respin suffix here
jbdsFixVersionWithRespin=9.1.0.Beta2a # a, b, c...
...
versionWithRespin=4.3.1.Beta2a # a, b, c...
respin="respin-a"
TARGET_PLATFORM_VERSION_MIN=4.50.2.Beta2-SNAPSHOT
TARGET_PLATFORM_VERSION_MAX=4.52.0.Beta2-SNAPSHOT
TARGET_PLATFORM_CENTRAL_MAX=4.52.0.Beta2-SNAPSHOT
jbdsFixVersion=9.1.0.Beta2 # no respin suffix here
jbtFixVersion=4.3.1.Beta2 # no respin suffix here
echo "
Subject:
