...
version=4.3.1.CR1 # or .Final
versionWithRespin=4.3.1.CR1 # a, b, c...
...
----
firefox \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/jbosstools-build.parent_4.3.mars/disable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/job/jbosstoolstargetplatforms-matrix/disable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/jbosstools-buildflow_4.3.mars/disable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/jbosstools-composite-install_4.3.mars/disable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/jbosstools-browsersim-standalone_4.3.mars/disable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/jbosstools-build-sites.aggregate.site_4.3.mars/disable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/jbosstools-build-sites.aggregate.coretests-site_4.3.mars/disable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/jbosstools-centraltarget_4.3.mars/disable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/jbosstools-build-sites.aggregate.child-sites_4.3.mars/disable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/devstudio.product_9.0.mars/disable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/devstudio.versionwatch_9.0.mars/disable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/jbosstools-install-p2director.install-tests.matrix_4.3.mars/disable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/jbosstools-install-grinder.install-tests.matrix_4.3.mars/disable
...
VERSION=CR1 # a, b, c... (not SNAPSHOT!)
...
echo "DONE: JBT discovery sites to staging/builds/ and staging/updates/" | grep "JBT discovery sites"
...
[source,bash]
----
version_PREV=4.3.1.Beta2b # a, b, c...
...
# TODO this needs a big revamp because we're now going to have the exact files in /staging/ that will be copied to /development/ ... give or take some simple sed string replacements
#/staging/#/development/# (update sites)
#/mars/#/static/mars/# (target platforms)
# etc.
...
[source,bash]
----
versionWithRespin_PREV=4.3.1.Beta2a # a, b, c...
TARGET_PLATFORM_VERSION_MAX_PREV=4.52.0.Beta2-SNAPSHOT
TARGET_PLATFORM_CENTRAL_MAX_PREV=4.52.0.Beta2-SNAPSHOT
...
scpr composite*.xml core/
git add composite*.xml core/composite*.xml

# push updated file to server
TOOLS=tools@filemgmt.jboss.org:/downloads_htdocs/tools
scp composite*.xml ${TOOLS}/mars/staging/updates/
scp core/composite*.xml ${TOOLS}/mars/staging/updates/core/
...
git commit -m "release JBT ${versionWithRespin} to QE" composite*.xml core/composite*.xml
...
jbdsFixVersionWithRespin=9.1.0.CR1 # a, b, c...
...
firefox $(egrep "/${version}/|/${versionWithRespin}/|/${jbdsFixVersion}/|/${jbdsFixVersionWithRespin}/" ide-config.properties | sed -e "s#.\+=\(.\+\)#\1#")
popd
...
----
firefox \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/jbosstools-build.parent_4.3.mars/enable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/job/jbosstoolstargetplatforms-matrix/enable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/jbosstools-buildflow_4.3.mars/enable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/jbosstools-composite-install_4.3.mars/enable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/jbosstools-browsersim-standalone_4.3.mars/enable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/jbosstools-build-sites.aggregate.site_4.3.mars/enable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/jbosstools-build-sites.aggregate.coretests-site_4.3.mars/enable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/jbosstools-centraltarget_4.3.mars/enable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/jbosstools-build-sites.aggregate.child-sites_4.3.mars/enable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/devstudio.product_9.0.mars/enable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/devstudio.versionwatch_9.0.mars/enable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/jbosstools-install-p2director.install-tests.matrix_4.3.mars/enable \
https://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/jbosstools-install-grinder.install-tests.matrix_4.3.mars/enable \
http://jenkins.mw.lab.eng.bos.redhat.com/hudson/view/DevStudio/view/DevStudio_9.0.mars/job/jbosstools-discovery_4.3.mars/configure
...
versionWithRespin=4.3.1.CR1 # a, b, c...
respin="respin-a"
TARGET_PLATFORM_VERSION_MIN=4.50.2.CR1-SNAPSHOT
TARGET_PLATFORM_VERSION_MAX=4.52.0.CR1-SNAPSHOT
TARGET_PLATFORM_CENTRAL_MAX=4.52.0.CR1-SNAPSHOT
jbdsFixVersion=9.1.0.CR1 # no respin suffix here
