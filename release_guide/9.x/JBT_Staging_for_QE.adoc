...
versionWithRespin=CR1b # a, b, c... (not SNAPSHOT!)
...
[source,bash]
----
versionWithRespin_PREV=4.3.1.CR1a # a, b, c...
TARGET_PLATFORM_VERSION_MAX_PREV=4.52.0.Final-SNAPSHOT
TARGET_PLATFORM_CENTRAL_MAX_PREV=4.52.0.Final-SNAPSHOT
...
jbdsFixVersionWithRespin=9.1.0.CR1b # a, b, c...
