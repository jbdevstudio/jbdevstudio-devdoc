...
versionWithRespin=4.3.1.Beta2 # a, b, c...
...
VERSION=Beta2 # a, b, c... (not SNAPSHOT!) 
...
[source,bash]
----
versionWithRespin_PREV=4.3.1.Beta1a # a, b, c...
TARGET_PLATFORM_VERSION_MAX_PREV=4.51.2.Beta1-SNAPSHOT
TARGET_PLATFORM_CENTRAL_MAX_PREV=4.51.0.Beta1-SNAPSHOT
...
jbdsFixVersionWithRespin=9.1.0.Beta2 # a, b, c...
