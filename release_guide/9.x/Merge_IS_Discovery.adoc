...
pushd /tmp
  ...
  ./mergeISdiscovery.sh -v 4.3.0.CR2 -vr 4.3.0.CR2 -is http://download.jboss.org/jbosstools/mars/snapshots/builds/integration-stack/discovery/4.3.0.Alpha2/
  ./mergeISdiscovery.sh -v 9.0.0.CR2 -vr 9.0.0.CR2 -is https://devstudio.redhat.com/9.0/staging/updates/integration-stack/discovery/9.0.0.Alpha2/ -JBDS
