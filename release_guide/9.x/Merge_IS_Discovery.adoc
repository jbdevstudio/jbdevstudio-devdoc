...
pushd /tmp
  ...
  ./mergeISdiscovery.sh -version 4.3.1.Beta1 -versionWithRespin 4.3.1.Beta1 -is http://download.jboss.org/jbosstools/mars/staging/updates/integration-stack/discovery/4.3.0.Alpha2/
  ./mergeISdiscovery.sh -version 9.1.0.Beta1 -versionWithRespin 9.1.0.Beta1 -is https://devstudio.redhat.com/9.0/staging/updates/integration-stack/discovery/9.0.0.Alpha2/ -JBDS
