...
pushd /tmp
  ...
  ./mergeISdiscovery.sh -version 4.3.1.CR1 -versionWithRespin 4.3.1.CR1b -is http://download.jboss.org/jbosstools/mars/staging/updates/integration-stack/discovery/4.3.0.CR1a/earlyaccess/
  ./mergeISdiscovery.sh -version 9.1.0.CR1 -versionWithRespin 9.1.0.CR1b -is https://devstudio.redhat.com/9.0/staging/updates/integration-stack/discovery/9.0.0.CR1a/earlyaccess/ -JBDS
...
# JBoss Tools
url=http://download.jboss.org/jbosstools/mars/staging/updates/discovery.central/4.3.1.CR1b/
...
# JBDS
url=https://devstudio.redhat.com/9.0/staging/updates/discovery.earlyaccess/9.1.0.CR1b/
