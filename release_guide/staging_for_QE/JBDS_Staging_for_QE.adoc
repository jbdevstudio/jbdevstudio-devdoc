...
versionWithRespin=9.0.1.GA # a, b, c...
...
oldTP=jboss-devstudio-9.0.1.CR2
newTP=jboss-devstudio-${versionWithRespin}
# Example for a respin
# oldTP=jboss-devstudio-9.0.1.CR2
# newTP=jboss-devstudio-9.0.1.CR2
...
jboss.discovery.directory.url|devstudio|9.0.1.GA=https://devstudio.redhat.com/updates/9.0-staging/devstudio-directory.xml
jboss.discovery.site.url|devstudio|9.0.1.GA=https://devstudio.redhat.com/updates/9.0-staging/
jboss.discovery.earlyaccess.site.url|devstudio|9.0.1.GA=https://devstudio.redhat.com/earlyaccess/9.0-staging/
----
...
and copy it do __https://devstudio.redhat.com/updates/9.0-staging/devstudio-earlyaccess.properties__.
...
scp devstudio-earlyaccess.properties ${JBDS}/updates/9.0-staging
...
jbdsVersion=9.0.1.GA # no respin suffix here
jbtVersion=4.3.1.Final # no respin suffix here
echo "
Subject: 
